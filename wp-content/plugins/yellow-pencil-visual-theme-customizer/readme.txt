...
== Description ==
**Style your WordPress site visually.** Discover the most popular front-end design plugin! [Try live demo](http://yellowpencil.waspthemes.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme).
...
[Purchase pro version](http://waspthemes.com/yellow-pencil/buy/) now to unlock all features.
...
== Screenshots ==
1. Applies a background color to an element.
2. Adds a background gradient to an element.
3. Editing font family.
...
11. CSS editor for professional users.
